...
//        Wallet wallet = new Wallet(trader, "CFA");
...
//        Wallet wallet = new Wallet(trader, "GHC");
...
//
//        Wallet createdWallet = walletService.createWallet(trader, "USD");
//
...
//        Wallet wallet = new Wallet(trader, "USD");
//        when(walletRepository.findWalletByTrader(trader)).thenReturn(wallet);
//
